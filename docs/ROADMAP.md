...
- [ ] Chat UI (admin) — streamed Claude responses; agent guides admin through filling `{title, category, tags, body, source, last_verified_at, sensitivity}`. *All prerequisites (items 1, 2, 4, 5) shipped — ready to start.*
